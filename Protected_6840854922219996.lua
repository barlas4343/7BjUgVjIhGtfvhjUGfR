...
local function createWatermark()
    ...
    local CHEAT_NAME = "Fatalice" -- Senin istediğin hile adı
    ...
    print("Watermark yeniden oluşturuldu ve ekrana s*çıldı!")
end
...
print("Nihai, Bug'sız, Düzgün Watermark Kodu Hazır!")
